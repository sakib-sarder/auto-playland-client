...
const Login = () => {
  ...
  return (
    <div className="flex flex-col-reverse md:flex-row container mx-auto h-[calc(100vh-64px)] items-center justify-center">
      <div className=" w-full md:w-1/2 my-auto  p-4 md:p-0">
        ...
        <p className="text-sm font-">
          ...
          <Link className="underline hover:text-blue-500">Register</Link>
        </p>
